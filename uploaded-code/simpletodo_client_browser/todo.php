		...
		<div class="textalignright marginbottom10">
			...
			<div id="newtodo_window" title="Create a new TODO item">
				<form method="POST" action="new_todo.php">
					...
					<p>Date Due:<br /><input type="text" class="datepicker" name="due_date" placeholder="YYYY-MM-DD" /></p>
		...
		<div id="todolist">
			...
			<div>
				...
				<div>
					...
					<p>Description:<br /><textarea class="span8 description" id="description_<?php echo $todo->todo_id; ?>" name="description"><?php echo $todo->description; ?></textarea></p>
				</div>
				<div class="textalignright">
