...
$apicaller = new ApiCaller('APP001', '28e336ac6c9423d9', 'http://www.dev.ishaexports.co.in/Code_Api_Centric/');
...
// print_r($todo_items->data);die;
if($todo_items->data == array())
{
	echo '<h1>Invalid UserName Or Password</h1>';die;
}
...
<div id="main" class="container">
      <div class="textalignright marginbottom10"> <span id="newtodo" class="btn info">Create a new TODO item</span>
    <div id="newtodo_window" title="Create a new TODO item">
        ...
        <p>Date Due:<br />
              <input type="text" class="datepicker" name="due_date" placeholder="YYYY-MM-DD" />
            </p>
        <p>Description:<br />
      ...
      <div id="todolist">
    <?php foreach($todo_items->data as $todo): ?>
    <h3><a href="#"><?php echo $todo->title; ?></a></h3>
    <div>
          <form method="POST" action="update_todo.php">
        <div class="textalignright"> <a href="delete_todo.php?todo_id=<?php echo $todo->todo_id; ?>">Delete</a> </div>
        <div>
              <p>Date Due:<br />
            <input type="text" id="datepicker_<?php echo $todo->todo_id; ?>" class="datepicker" name="due_date" value="<?php echo $todo->due_date; ?>" />
          </p>
              <p>Description:<br />
            <textarea class="span8 description" id="description_<?php echo $todo->todo_id; ?>" name="description"><?php echo $todo->description; ?></textarea>
          </p>
            </div>
